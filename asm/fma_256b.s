...
.LFE5833:
	...
	.globl	_Z16vectorized_macroPffS_m
	.type	_Z16vectorized_macroPffS_m, @function
_Z16vectorized_macroPffS_m:
.LFB5834:
	.loc 2 26 1
	.cfi_startproc
	endbr64
...
#NO_APP
	vmovaps	%ymm0, -56(%rsp)
	.loc 2 34 19 discriminator 2
	vmovss	-84(%rsp), %xmm0
#APP
# 34 "intrinsic_functions/fma_256b.cpp" 1
...
#NO_APP
	vmovaps	%ymm0, 8(%rsp)
	.loc 2 36 9 discriminator 2
	vmovaps	-56(%rsp), %ymm1
	vmovaps	-24(%rsp), %ymm2
	vmovaps	8(%rsp), %ymm0
#APP
# 36 "intrinsic_functions/fma_256b.cpp" 1
...
.LBE16:
	...
	.cfi_endproc
.LFE5834:
	.size	_Z16vectorized_macroPffS_m, .-_Z16vectorized_macroPffS_m
	.section	.rodata
	.align 8
.LC5:
...
.L20:
	...
	movl	-148(%rbp), %eax
	cltq
	.loc 2 58 23 discriminator 3
	cmpq	%rax, -104(%rbp)
	jbe	.L19
	.loc 2 60 12 discriminator 2
	movq	-128(%rbp), %rdx
	.loc 2 60 11 discriminator 2
	movl	-148(%rbp), %eax
	cltq
	.loc 2 60 12 discriminator 2
	salq	$2, %rax
	addq	%rdx, %rax
	.loc 2 60 14 discriminator 2
	vmovss	.LC6(%rip), %xmm0
	vmovss	%xmm0, (%rax)
	.loc 2 61 12 discriminator 2
	movq	-120(%rbp), %rdx
	.loc 2 61 11 discriminator 2
	movl	-148(%rbp), %eax
	cltq
	.loc 2 61 12 discriminator 2
	salq	$2, %rax
	addq	%rdx, %rax
	.loc 2 61 14 discriminator 2
	vmovss	.LC4(%rip), %xmm0
	vmovss	%xmm0, (%rax)
	.loc 2 62 12 discriminator 2
	movq	-112(%rbp), %rdx
	.loc 2 62 11 discriminator 2
	movl	-148(%rbp), %eax
	cltq
	.loc 2 62 12 discriminator 2
	salq	$2, %rax
	addq	%rdx, %rax
	.loc 2 62 14 discriminator 2
	vxorps	%xmm0, %xmm0, %xmm0
	vmovss	%xmm0, (%rax)
	.loc 2 58 5 discriminator 2
	incl	-148(%rbp)
	jmp	.L20
.L19:
.LBE18:
...
.LEHE1:
	.loc 2 66 9 is_stmt 0 discriminator 1
	leaq	-96(%rbp), %rdx
	leaq	-64(%rbp), %rax
	movq	%rdx, %rsi
	movq	%rax, %rdi
...
.LBB20:
	...
	movl	$0, -144(%rbp)
.L22:
	.loc 2 70 21 discriminator 3
	movl	-144(%rbp), %eax
	cltq
	.loc 2 70 23 discriminator 3
	cmpq	%rax, -104(%rbp)
	jbe	.L21
	.loc 2 72 12 discriminator 2
	movq	-128(%rbp), %rdx
	.loc 2 72 11 discriminator 2
	movl	-144(%rbp), %eax
	cltq
	.loc 2 72 12 discriminator 2
	salq	$2, %rax
	addq	%rdx, %rax
	.loc 2 72 14 discriminator 2
	vmovss	.LC6(%rip), %xmm0
	vmovss	%xmm0, (%rax)
	.loc 2 73 12 discriminator 2
	movq	-120(%rbp), %rdx
	...
	salq	$2, %rax
	addq	%rdx, %rax
	.loc 2 73 14 discriminator 2
	vmovss	.LC4(%rip), %xmm0
	vmovss	%xmm0, (%rax)
	.loc 2 74 12 discriminator 2
	movq	-112(%rbp), %rdx
	.loc 2 74 11 discriminator 2
	movl	-144(%rbp), %eax
	cltq
	.loc 2 74 12 discriminator 2
	salq	$2, %rax
	addq	%rdx, %rax
	.loc 2 74 14 discriminator 2
	vxorps	%xmm0, %xmm0, %xmm0
	vmovss	%xmm0, (%rax)
	.loc 2 70 5 discriminator 2
	incl	-144(%rbp)
	jmp	.L22
.L21:
.LBE20:
...
.LEHB3:
	call	_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_@PLT
.LEHE3:
	.loc 2 78 9 is_stmt 0 discriminator 1
	leaq	-96(%rbp), %rdx
	leaq	-64(%rbp), %rax
	movq	%rdx, %rsi
	movq	%rax, %rdi
...
.L24:
	...
	movl	-140(%rbp), %eax
	cltq
	.loc 2 82 23 discriminator 3
	cmpq	%rax, -104(%rbp)
	jbe	.L23
	.loc 2 84 12 discriminator 2
	movq	-128(%rbp), %rdx
	.loc 2 84 11 discriminator 2
	movl	-140(%rbp), %eax
	cltq
	.loc 2 84 12 discriminator 2
	salq	$2, %rax
	addq	%rdx, %rax
	.loc 2 84 14 discriminator 2
	vmovss	.LC6(%rip), %xmm0
	vmovss	%xmm0, (%rax)
	.loc 2 85 12 discriminator 2
	movq	-120(%rbp), %rdx
	.loc 2 85 11 discriminator 2
	movl	-140(%rbp), %eax
	cltq
	.loc 2 85 12 discriminator 2
	salq	$2, %rax
	addq	%rdx, %rax
	.loc 2 85 14 discriminator 2
	vmovss	.LC4(%rip), %xmm0
	vmovss	%xmm0, (%rax)
	.loc 2 86 12 discriminator 2
	movq	-112(%rbp), %rdx
	.loc 2 86 11 discriminator 2
	movl	-140(%rbp), %eax
	cltq
	.loc 2 86 12 discriminator 2
	salq	$2, %rax
	addq	%rdx, %rax
	.loc 2 86 14 discriminator 2
...
.LEHB5:
	call	_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_@PLT
.LEHE5:
	.loc 2 90 9 is_stmt 0 discriminator 1
	leaq	-96(%rbp), %rdx
	leaq	-64(%rbp), %rax
	movq	%rdx, %rsi
	movq	%rax, %rdi
...
.LEHE6:
	...
	vmovd	%ecx, %xmm0
	movq	%rax, %rdi
	call	_Z16vectorized_macroPffS_m
	.loc 2 90 9
	leaq	-64(%rbp), %rax
	movq	%rax, %rdi
	call	_ZN5TimerD1Ev
...
.LFB6364:
	...
	cmpl	$1, -4(%rbp)
	jne	.L47
	.loc 2 109 1 is_stmt 0 discriminator 1
	cmpl	$65535, -8(%rbp)
	jne	.L47
...
.LASF645:
	.string	"fgetwc"
.LASF1003:
	.string	"_Z16vectorized_macroPffS_m"
.LASF646:
	.string	"fgetws"
.LASF766:
